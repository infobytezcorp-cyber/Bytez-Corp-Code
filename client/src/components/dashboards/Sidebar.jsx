...
//   // { label: "Staff",      path: "/staff",     icon: icons.clients    },
...
//               {/* <NavItem label="Hr&Staff"         path="/staff"    icon={icons.clients} collapsed={collapsed} isActive={location.pathname === "/staff"}    onClick={() => navigate("/staff")} /> */}
